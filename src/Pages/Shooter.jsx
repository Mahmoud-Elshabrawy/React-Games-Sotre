...
import Categories from '../Components/Categories';
    ...
    const displayedGames = shooter.slice(firstGameIdx, lastGameIdx);
    const options = {
        method: 'GET',
        headers: {
    ...
    return (
        <div>
            <div className='d-flex flex-column justify-content-center align-items-center' style={{ backgroundColor: '#007aff', height: '250px', 
                ...
                <i class="fa-solid fa-chevron-right " style={{fontSize: '15px'}}></i> Shooter</h5>
            </div>
            ...
            <Pagination totalGames={shooter.length} gamesPerPage={gamesPerPage}
